  ...
  build: {
    ...
    rollupOptions: {
      input: {
        ...
        // Live engine (issues wbc-mjlab-5sq/bpu/uxq): mujoco-wasm physics +
        // onnxruntime-web policy + the deploy obs/action/PD pipeline.
        'spike-live': resolve(__dirname, 'spike-live.html'),
      },
    },
  },
});
